...
print('Ref point:', f'({cpacs.aircraft.ref_point_x}, \
...
simple_aeromap.add_row(mach=0.555, alt=15000, aos=0.0, aoa=2.4,
                       cd=0.001, cl=1.1, cs=0.22, cmd=0.22)
...
for i in range(12):
    new_aeromap.add_row(mach=0.555, alt=15000, aos=0.0, aoa=i,
                        cd=0.001 * i**2, cl=0.1 * i, cs=0.0, cmd=0.0, cml=1.1, cms=0.0)
...
duplicated_aeromap.add_row(mach=0.666, alt=10000, aos=0.0, aoa=2.4,
                           cd=0.001, cl=1.1, cs=0.22, cmd=0.22)
...
aeromap_dd.add_damping_derivatives(alt=15000, mach=0.555, aos=0.0, aoa=0.0,
                                   coef='cd', axis='dp', value=0.001, rate=-1.0)

# Same in a loop
for i in range(11):
    aeromap_dd.add_damping_derivatives(alt=15000, mach=0.555, aos=0.0, aoa=i + 1,
                                       coef='cd', axis='dp', value=0.001 * i + 0.002, rate=-1.0)
aeromap_dd.save()
...
print(aeromap_dd.get_damping_derivatives(alt=15000, mach=0.555, aoa=[4.0, 6.0, 8.0],
                                         coef='cd', axis='dp', rates='neg'))
